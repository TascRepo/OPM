...
namespace OPM.GUI
{
    public partial class TestTableForm : Form
    {
        ...
        {
            object filename = string.Format(@"C:\Users\XUANTHANH\Desktop\TestTable1.docx");
            object path = @"C:\Users\XUANTHANH\Desktop\TestTable.docx";
            ...
            {
                MessageBox.Show(@"Không tìm thấy file C: \Users\XUANTHANH\Desktop\TestTable.docx");
                return @"Không tìm thấy file C: \Users\XUANTHANH\Desktop\TestTable.docx";
            }
        }
