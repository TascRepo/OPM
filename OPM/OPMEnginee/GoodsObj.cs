...
namespace OPM.OPMEnginee
{
    public class GoodsObj
    {
        ...
        public GoodsObj() { }
        public GoodsObj(string idContract, string name, string origin, string manufacturer = "VNPT Technology", string code = "iGate GW020-H", string unit = "Bộ", double priceUnit = 0, int quantity = 0, string note = "", string license = "Bản quyền ONT VNPT Techlonogy", string name1 = "Thiết bị đầu cuối ONT loại  (2FE/GE + Wifi Dualband)")
        {
        ...
        public GoodsObj(string idContract)
        {
        ...
        public GoodsObj(string idContract, string name)
        {
        ...
        public static List<GoodsObj> GetList()
        {
            List<GoodsObj> list = new List<GoodsObj>();
            string query = string.Format("SELECT * FROM dbo.Contract_Goods");
            DataTable dataTable = OPMDBHandler.ExecuteQuery(query);
            foreach (DataRow row in dataTable.Rows)
            {
                GoodsObj contract_Goods = new GoodsObj(row);
                list.Add(contract_Goods);
            }
            return list;
        }
        public static List<GoodsObj> GetListByIdContract(string idContract)
        {
            List<GoodsObj> list = new List<GoodsObj>();
