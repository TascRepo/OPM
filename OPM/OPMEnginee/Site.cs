...
namespace OPM.OPMEnginee
{
    public class Site
    {
        ...
        public Site() { }
        public Site(string id, string type, string headquater, string address, string phonenumber, string fax, string tax, string account, string representative1, string position1, string proxy1, string representative2, string position2, string proxy2, string representative3, string position3, string proxy3)
        {
            Id = id;
            Type = type;
        ...
        {
            string query = string.Format("SELECT * FROM dbo.Site");
        ...
        public static List<Site> GetList()
        {
            ...
            string query = string.Format("SELECT * FROM dbo.Site order by id");
        ...
        public void Update()
        {
            ...
            {
                string query = string.Format("UPDATE dbo.Site SET type = '{1}', headquater = N'{2}', address= N'{3}', phonenumber = '{4}',fax = '{5}', tax= '{6}', account = '{7}',representative1 = N'{8}',position1 = N'{9}',proxy1 = N'{10}',representative2 = N'{11}',position2 = N'{12}',proxy2 = N'{13}',representative3 = N'{14}',position3 = N'{15}',proxy3 = N'{16}' WHERE id = N'{0}'", id, type, headquater, address, phonenumber, fax, tax, account, representative1, position1, proxy1, representative2, position2, proxy2, representative3, position3, proxy3);
                try
                {
        ...
        public void Insert()
        {
            //string query = string.Format(@"INSERT INTO dbo.Site(id, type, headquater, address, phonenumber, fax, tax, account, representative1, position1,proxy1, representative2, position2,proxy2, representative3, position3, proxy3) VALUES(N'{0}','{1}',N'{2}',N'{3}','{4}','{5}','{6}','{7}',N'{8}',N'{9}',N'{10}',N'{11}',N'{12}',N'{13}',N'{14}',N'{15}',N'{16}')", id, type, headquater, address, phonenumber, fax, tax, account, representative1, position1, proxy1, representative2, position2, proxy2, representative3, position3, proxy3);
            string query = string.Format(@"INSERT INTO dbo.Site VALUES(N'{0}','{1}',N'{2}',N'{3}','{4}','{5}','{6}','{7}',N'{8}',N'{9}',N'{10}',N'{11}',N'{12}',N'{13}',N'{14}',N'{15}',N'{16}')", id, type, headquater, address, phonenumber, fax, tax, account, representative1, position1, proxy1, representative2, position2, proxy2, representative3, position3, proxy3);
            try
            {
                OPMDBHandler.ExecuteNonQuery(query);
