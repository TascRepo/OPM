...
namespace OPM.DBHandler
{
    ...
    {
        //static string connectionSTR = @"Data Source=XUANTHANH\SQLEXPRESS;Initial Catalog=OpmDB;Persist Security Info=True;Connect Timeout = 30;User ID=sa;Password=661888";
